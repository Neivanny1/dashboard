...
(function(factory) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var defaults = {
            ...
            default_month, default_year, disabled_dates = [],
            enabled_dates = [],
            end_date, first_selectable_day,
            ...
            show_select_today, start_date, timeout, timepicker, timepicker_config, touchmove = false,
            uniqueid = '',
            yearpicker,
